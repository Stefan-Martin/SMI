...
int main(int argc, char *argv[])
{
	...
	options.n_chan = 16; //Can be 2,3,or 16. Don't ask
	options.n_scan = 10000; //Length to record, note that this is in scans, not seconds.
	options.freq = 80000.0; //Sampling Frequency
	options.physical=1; //Scale output to (-0.75,0.75)
	options.verbose=0;
